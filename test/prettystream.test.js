...
describe('A PrettyStream', function(){
  ...
  it('should pretty print uncolored log statements with extra fields', function(){
    var prettyStream = new PrettyStream({useColor: false});
  ...
  it('should pretty print colored log statements', function(){
  ...
  it('should pretty print colored log statements if output is a TTY', function(done){
  ...
  it('should pretty print uncolored log statements if output is not a TTY', function(done){
    var prettyStream = new PrettyStream({useColor: 'auto'});
    var ts = new TestStream(function(result) {
      result.should.equal('[2012-02-08T22:56:52.856Z]  INFO: myservice/123 on example.com: My message\n');
    }, done);
  ...
  it('should pretty print simple request log statements', function(){
    var prettyStream = new PrettyStream({useColor: false});
  ...
  it('should pretty print detailed request and response log statements', function(){
    var prettyStream = new PrettyStream({useColor: false});
